...
@Component
public class GreetingsInitializer {
    ...
    @Autowired
    public GreetingsInitializer(GreetingsRepository greetingsRepository) {
    ...
    public void init() {
        ...
        try (FileReader reader = new FileReader(resourceFile.getFile())) {
            ...
            for (Object greeting : jsonArray) {
                ...
                greetingsRepository.addGreeting(new Greeting(id, createdBy, greetingStr, originCountry, nationality));
            }
